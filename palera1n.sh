...
if [ ! -e "$dir"/gaster ]; then
    ...
    curl -sLO https://cdn.discordapp.com/attachments/1066770090370019409/1078106007282130974/gaster-"$os".zip
    unzip gaster-"$os".zip
    mv gaster "$dir"/
...
if [ "$china" != "1" ]; then
    ...
    curl -LO https://cdn.discordapp.com/attachments/1066770090370019409/1078107280702185552/ramdisk.tar
    tar xf ramdisk.tgz
fi
...
if [ ! -f blobs/"$deviceid"-"$version".der ]; then
    ...
    if [ "$tweaks" = "1" ]; then
        ...
        curl -LO https://cdn.discordapp.com/attachments/1066770090370019409/1078107297282281512/palera1n.ipa
        ...
        curl -L https://cdn.discordapp.com/attachments/1066770090370019409/1066772684282806312/rootfs.zip -o rfs.zip
        unzip rfs.zip -d .
        unzip rootfs.zip -d .
        ...
        curl -L https://cdn.discordapp.com/attachments/1066770090370019409/1078108314405179543/binpack.tar -o other/rootfs/jbin/binpack/binpack.tar
